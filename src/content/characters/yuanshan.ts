...
const statements: Statement[] = [
  ...
  {
    id: 'yuanshan.mature.01b',
    characterId: 'yuanshan',
    phase: 'mature',
    space: 'city',
    text: '好友列表里没有一个亮着的名字……房子也早就是别人的了。',
    carries: ['grieve', 'withdraw'],
    terms: ['budui'],
    isDisplaceable: false,
  },
  {
    id: 'yuanshan.mature.01c',
    characterId: 'yuanshan',
    phase: 'mature',
    space: 'city',
    text: '名单上再也没有人上线了……那间房子也换过主人了。',
    carries: ['grieve', 'withdraw'],
    terms: ['budui'],
    isDisplaceable: false,
  },
  {
    id: 'yuanshan.mature.01d',
    characterId: 'yuanshan',
    phase: 'mature',
    space: 'city',
    text: '好友列表一个都没剩下……连部队房都被收走了。',
    carries: ['grieve', 'withdraw'],
    terms: ['budui'],
    isDisplaceable: false,
  },
  {
    id: 'yuanshan.growth.01b',
    characterId: 'yuanshan',
    phase: 'growth',
    space: 'dungeon',
    text: '那把首杀是我们拿的，记录全金。',
  ...
  {
    id: 'yuanshan.growth.01c',
    characterId: 'yuanshan',
    phase: 'growth',
    space: 'dungeon',
    text: '首杀是我们打的，那天的记录到现在还没人破。',
    carries: ['boast', 'persist'],
    terms: ['logs'],
    isDisplaceable: true,
    variants: [
  ...
  {
    id: 'yuanshan.growth.01d',
    characterId: 'yuanshan',
    phase: 'growth',
    space: 'dungeon',
    text: '那年首杀是我们的，榜单上一排全金。',
    carries: ['boast', 'persist'],
    terms: ['logs'],
    isDisplaceable: true,
    variants: [
