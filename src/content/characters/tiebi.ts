...
const statements: Statement[] = [
  ...
  },
  {
    ...
    phase: 'mentor',
    space: 'linkshell',
    text: '哪天你挂着放浪神加护回来，在跨服通讯贝里喊一声就行。位置一直空着。',
    carries: ['reassure', 'invite'],
    terms: ['fuqiang', 'cwls'],
    isDisplaceable: false,
  },
    ...
    variants: [
      {
        kind: 'transform',
        targetPhase: 'growth',
        reinterpretedText: '这句话被拖到他建起部队之后——他终于不必再求人，却还是会想起当年没人回他的那几分钟。',
        carries: ['reminisce', 'grieve'],
      },
      {
        kind: 'high',
        reinterpretedText: '两个时间被折在一起：求带的人已经在带人了，而带人的那个人还在求。这句话此刻不属于任何一个时间。',
        carries: ['grieve', 'confide'],
      },
    ],
  },
    ...
    variants: [
      {
        kind: 'microshift',
        targetSpace: 'linkshell',
        reinterpretedText: '同一句话放到公开频道里，就成了一句招牌——从那天起，他每天都要把它兑现一遍。',
        carries: ['persist', 'reassure'],
      },
      {
        kind: 'transform',
        targetPhase: 'mature',
        reinterpretedText: '在成熟期，这句话变成了一次检讨——他已经知道自己做不到「谁都不会被丢下」，但他没有改口。',
        carries: ['grieve', 'persist'],
      },
      {
        kind: 'transform',
        targetPhase: 'mentor',
        reinterpretedText: '他终于算清「不丢下任何人」的代价是多少，然后决定继续付。这句话不再许愿，它只是结论。',
        carries: ['persist', 'recruit'],
      },
    ],
  },
    ...
    variants: [
      {
        kind: 'transform',
        targetPhase: 'growth',
        reinterpretedText: '被拖回成长期，这句话像一次过早的放手——那时的他其实还想把每一个人都攥在手里。',
        carries: ['persist'],
      },
      {
        kind: 'transform',
        targetPhase: 'mentor',
        reinterpretedText: '在导师期它不再是谦让，而是一句承诺：这个地方永远有你的位置，哪怕你不再回来。',
        carries: ['reassure', 'recruit'],
      },
    ],
  },
    ...
    variants: [
      {
        kind: 'transform',
        targetPhase: 'mature',
        reinterpretedText: '在成熟期，这句话还说不出口——他嘴上说着欢迎，手还搭在门闩上，没打算真的松开。',
        carries: ['persist', 'withdraw'],
      },
      {
        kind: 'high',
        reinterpretedText: '这句话被送回他还在求带的那些年：那时的他没有门，也没有一个可以让谁回来的地方。',
        carries: ['grieve', 'confide'],
      },
    ],
  },
